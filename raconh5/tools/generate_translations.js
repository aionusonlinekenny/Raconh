...
const DICT = {
    ...
    // Pets / Relic Stuff (墨宠)
    '霸气墨宠':         'Dominator Pet',
    '霸气墨宠现世':     'Dominator Pet Active',
    '开启墨宠助战':     'Activate Pet Support',
    '输出暴涨30%':      'Output +30%',
    '墨宠碎片壹':       'Pet Fragment I',
    '墨宠碎片贰':       'Pet Fragment II',
    '墨宠碎片叁':       'Pet Fragment III',
    '墨宠碎片肆':       'Pet Fragment IV',
    '未激活':           'Not Activated',
    // Quest / Activity
    '自动任务':         'Auto Quest',
    '寻找神蛊':         'Find Spirit Gu',
    '神蛊传闻':         'Spirit Gu Legend',
    '最强群攻':         'Strongest AoE',
    '强化':             'Enhance',
    '再炼':             'more stage(s)',
    // UI labels (cw.txt sections)
    '战力':     'Power',
    '等级':     'Level',
    '职业':     'Class',
    '返回':     'Return',
    ...
    '盟会战': 'Guild War',
    '到达': 'Reach',
    '关后开启': 'stages to unlock',
    '副本': 'Dungeon',
    '剧情副本': 'Story Dungeon',
    '世界': 'World',
    '精英': 'Elite',
    // Map / Scene names (common ones)
    '凌云山': 'Cloudy Peak',
    '龙渊谷': 'Dragon Abyss Valley',
    '天罡坡': 'Celestial Slope',
    '初生之地': 'Birthplace',
};
