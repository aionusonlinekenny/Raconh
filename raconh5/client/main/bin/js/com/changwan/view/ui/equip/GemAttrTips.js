 ...
 * Simon 2017.11.27
 */
var GemAttrTips = /** @class */ (function (_super) {
    ...
    GemAttrTips.prototype.setInfo = function (level) {
        ...
        if (curInfo) {
            ...
            for (var i = 0; i < curInfo.attr.length; i++) {
                curAttr += AttrDescType.getAttrName(curInfo.attr[i][0]) + "+" + curInfo.attr[i][1] + "      ";
            }
        ...
        if (nextInfo) {
            ...
            for (var i = 0; i < nextInfo.attr.length; i++) {
                nextAttr += AttrDescType.getAttrName(nextInfo.attr[i][0]) + "+" + nextInfo.attr[i][1] + "      ";
            }
