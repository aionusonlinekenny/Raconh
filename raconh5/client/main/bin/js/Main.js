...
var Main = /** @class */ (function (_super) {
    ...
    Main.prototype.loadVersion = function () {
        RES.getResByUrl("resource/res/version.txt?v=" + version, this.onLoadVersionComplete, this, RES.ResourceItem.TYPE_BIN);
    };
    Main.prototype.onLoadVersionComplete = function (data, url) {
        ...
        while (bytes.bytesAvailable > 0) {
            new PathInfo(bytes.readUTF(), bytes.readUTF(), bytes.readInt(), bytes.readInt());
        }
        this.loadDatas();
        RES.destroyRes(url);
    };
