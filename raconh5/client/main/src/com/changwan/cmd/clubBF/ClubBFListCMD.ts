 ...
 * create 2018.2.1
 */
class ClubBFListCMD extends BaseCMD
{
	public constructor() 
	{
        super();
        this._protocol = Protocol.CLUB_BF_LIST;
	}
...
//                 )),
        ...
        let defList:Array<ClubBFPlayerInfo> = [];
        let info:ClubBFPlayerInfo;
        ...
        let atkList:Array<ClubBFPlayerInfo> = [];
        len = pi.readShort();
        while(len--)
        {
