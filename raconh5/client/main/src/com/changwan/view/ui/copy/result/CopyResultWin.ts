 ...
 * create 2017-12-1
 */
class CopyResultWin extends UIComponent implements IViewManager
{
    ...
    {
        super();
        this.skinName = Manager.path.getSkinName("copy", "CopyResultWinSkin");
    ...
    */
	...
	private countDown():void
	{
		...
		if(left == 0)
		{
			Manager.view.hide(ViewID.CopyResultWin);
			return;
		}
