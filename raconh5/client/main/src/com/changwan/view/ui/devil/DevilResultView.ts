...
class DevilResultView extends UIComponent implements IViewManager
{
    ...
    public constructor()
    {
        ...
        this.skinName = Manager.path.getSkinName("devil", "DevilResultViewSkin");
    }
    ...
    protected configUI():void
    {
        ...
        if(this._back == null)
        {
            let path = Manager.path.getRelicStuffPath("relicStuffdi2");
        ...
        if(this._title == null)
        {
            let path = Manager.path.getDevilPath("king_title");
    ...
    {
        let resultInfo = Manager.model.getDevil().resultInfo;
        ...
        //获得物品
        let len = resultInfo.rewards != null ? resultInfo.rewards.length : 0;
    ...
    {
        Manager.view.hide(ViewID.DevilResultView);
    }
    ...
    public dispose():void
    {
        ...
        this._back = null;
        if(this._role != null) Manager.pool.push(this._role);
        this._role = null;
        if(this._title != null) Manager.pool.push(this._title);
        this._title = null;
        if(this._fightNum != null) Manager.pool.push(this._fightNum);
        this._fightNum = null;
        if(this._itemObject != null) this._itemObject.dispose();
