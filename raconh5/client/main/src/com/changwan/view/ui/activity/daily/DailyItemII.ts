 ...
 * create 2017-3-21
 */
class DailyItemII extends ItemRenderer
{
    ...
    private _isInTime:boolean;

    public constructor()
    {
        super();
        this.skinName = Manager.path.getSkinName("activity", "DailyItemSkinII");
    }
    ...
    private updateDaily(e:ActivityEvent = null):void
    {
        ...
        if(this._isInTime) this._txtTime.textColor = Color.GREEN;
        else if(iconCVO.endTime <= Manager.model.getLogin().serverTimeInfo.todaySeconds) this._txtTime.textColor = Color.RED;
    ...
    private onClickHandler(e:egret.TouchEvent):void
    {
        switch(e.currentTarget)
        {
            ...
            case this._btn1:
                ...
                else Manager.control.getActivity().getDailyRewards(this._cvo.id);
                break;
            case this._btnAdd:
                this.buyCount();
                break;
