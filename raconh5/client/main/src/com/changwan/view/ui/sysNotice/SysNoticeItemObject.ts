 ...
 * 2018.4.9
 */
class SysNoticeItemObject extends RenderSprite
{
    private static ITEM_WIDTH:number = 160;
    ...
    private drawItems():void
    {
        ...
        for(let i:number=0; i<this._itemInfoList.length; i++)
        {
            ...
            /**背景图 */
            let bg:BitmapRes = Manager.pool.create(BitmapRes, "common_itemBg_png");//common_di2_png
            bg.x = itemX;
            bg.y = itemY;
     ...
     * spacing:间距
     */
	public reuse(itemInfoList:Array<ItemsModelInfo>, col:number = 10, spacing:number = 11):void
	{
