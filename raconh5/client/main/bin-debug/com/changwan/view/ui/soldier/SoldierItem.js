...
var SoldierItem = (function (_super) {
    __extends(SoldierItem, _super);
    function SoldierItem() {
        var _this = _super.call(this) || this;
        _this.skinName = Manager.path.getSkinName("soldier", "SoldierItemSkin");
        return _this;
    }
    SoldierItem.prototype.createChildren = function () {
    ...
    SoldierItem.prototype.addEvent = function () {
    ...
    SoldierItem.prototype.removeEvent = function () {
    ...
    SoldierItem.prototype.onClickHandler = function (e) {
        var cvo = this.data;
        this._effGup.visible = cvo.id == e.params;
    };
    SoldierItem.prototype.onPutonHandler = function (e) {
        var cvo = this.data;
        this._dangqianImg.visible = cvo.id == this._model.currentId;
    };
    SoldierItem.prototype.onUpdateInfoHandler = function (e) {
    ...
    SoldierItem.prototype.dataChanged = function () {
        var cvo = this.data;
        var less = new GainLossVO(cvo.starInfoList[1].loss);
    ...
    SoldierItem.prototype.dispose = function () {
        this.removeEvent();
...
__reflect(SoldierItem.prototype, "SoldierItem");
//# sourceMappingURL=SoldierItem.js.map