 ...
 * 传功提示
 */
var ChuangongAwardView = (function (_super) {
    __extends(ChuangongAwardView, _super);
    function ChuangongAwardView() {
    ...
    ChuangongAwardView.prototype.start = function () {
    ...
    ChuangongAwardView.prototype.addEvent = function () {
    ...
    ChuangongAwardView.prototype.removeEvent = function () {
    ...
    ChuangongAwardView.prototype.onResizeHandler = function (e) {
        this.x = Math.round((Manager.global.gameMain.stage.stageWidth - this.width) / 2);
    };
    ChuangongAwardView.prototype.onClickHandler = function (e) {
        switch (e.currentTarget) {
            case this._okBtn:
                ...
                if (this._type == 3) {
                    var info = TrainingCVO.getInfo(this._type);
                    if (info) {
        ...
        Manager.view.hide(82 /* ChuangongAwardView */);
    };
    ChuangongAwardView.prototype.show = function (type) {
        this._type = type;
        this.updateInfo();
        Manager.layer.tipImageLayer.addChild(this);
    };
    ChuangongAwardView.prototype.addObject = function () {
        var value = [];
    ...
    ChuangongAwardView.prototype.removeObject = function () {
        var value = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            value[_i] = arguments[_i];
        }
    ...
    ChuangongAwardView.prototype.hide = function () {
        this.dispose();
    };
    ChuangongAwardView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
        ObjectUtil.removes(this._baseView, this._titleBg, this._txt, this._tips, this._goldImg, this._goldTxt, this._goldValue, this._okBtn, this._cancelBtn, this._okImg, this._cancelImg, this._item1, this._item2, this._item3);
        if (this._baseView)
    ...
    return ChuangongAwardView;
}(Sprite));
__reflect(ChuangongAwardView.prototype, "ChuangongAwardView");
//# sourceMappingURL=ChuangongAwardView.js.map