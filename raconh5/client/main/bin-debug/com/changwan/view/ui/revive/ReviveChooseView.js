 ...
 * create 2017-12-06
*/
var ReviveChooseView = (function (_super) {
    __extends(ReviveChooseView, _super);
    function ReviveChooseView() {
        var _this = _super.call(this) || this;
        _this.FREE_BTN_X = 100;
        _this.LOSS_BTN_X = 451;
        _this.ARROW_W = 36;
        _this.DIFFER_LABEL_W = 162;
        _this.touchChildren = true;
        _this.skinName = Manager.path.getSkinName("revive", "ReviveChooseViewSkin");
        return _this;
    }
    ReviveChooseView.prototype.configUI = function () {
        _super.prototype.configUI.call(this);
        this._imageBg1.load(Manager.path.getCommonPath("diwenBack1.png"));
        this._baseView.closeBtn.visible = false;
    };
    ReviveChooseView.prototype.addEvent = function () {
    ...
    ReviveChooseView.prototype.removeEvent = function () {
    ...
    ReviveChooseView.prototype.drawAll = function () {
        _super.prototype.drawAll.call(this);
        this.drawLayout();
    };
    ReviveChooseView.prototype.draw = function () {
        _super.prototype.draw.call(this);
        if (this.isInvalid(InvalidationType.LAYOUT))
            this.drawLayout();
    };
    ReviveChooseView.prototype.drawLayout = function () {
        //付费表数据
        ...
        this.setSecondValue();
        //战力对比
        var differ = Manager.model.self.attrInfo.fight - this._fightValue;
        var isSelfLess = differ < 0;
        ...
        //操作按钮
        var free = ReviveType.checkType(this._mapCvo.id, ReviveType.FREE_ALERT);
        var loss = ReviveType.checkType(this._mapCvo.id, ReviveType.PAY_ALERT);
        ...
        if (free && loss) {
            ...
            this._lossBtn.x = (720 - this._lossBtn.width) / 2;
        else
            this._freeBtn.x = (720 - this._freeBtn.width) / 2;
        //拥有元宝
        if (!this._moneyView) {
    ...
    ReviveChooseView.prototype.setSecondPosition = function () {
        if (!this._second)
            return;
        this._second.x = (720 - this._second.width) / 2 - 10;
    };
    ReviveChooseView.prototype.onTouchHandler = function (e) {
        ...
        switch (e.currentTarget) {
            ...
            case this._lossBtn:
                if (Manager.model.self.attrInfo.gold < this._cost) {
                    var cvo = ItemsCVO.getCvo(ItemsConst.YUAN_BAO);
                    Manager.view.show(9 /* ItemsTips */, cvo);
                }
                else
                    Manager.control.getBattle().reviveApply(0);
                break;
        }
    };
    ReviveChooseView.prototype.countdown = function () {
        this._life--;
        if (this._life <= 0) {
    ...
    ReviveChooseView.prototype.setSecondValue = function () {
        if (this._second == null)
            return;
        this._second.setValue(this._life, "nums_cd_", 25);
        this._second.x = (720 - this._second.width) / 2 - 10;
    };
    ReviveChooseView.prototype.show = function (serverID, name, fight) {
        var _this = this;
        if (!this.parent) {
    ...
    ReviveChooseView.prototype.hide = function () {
        if (this.parent)
            this.dispose();
    };
    ReviveChooseView.prototype.dispose = function () {
    ...
    return ReviveChooseView;
}(UIComponent));
__reflect(ReviveChooseView.prototype, "ReviveChooseView", ["IViewManager"]);
//# sourceMappingURL=ReviveChooseView.js.map