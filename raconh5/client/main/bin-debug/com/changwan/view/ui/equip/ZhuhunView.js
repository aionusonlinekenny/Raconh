 ...
 * Simon 2017.11.16
 */
var ZhuhunView = (function (_super) {
        ...
        if (this._curCvoInfo) {
            ...
            for (var i = 0; i < this._curCvoInfo.zhuhunAttrList.length; i++) {
                ...
                if (attrInfo && attrInfo.format == 1) {
                    ...
                    this._curAttrList[i].text = AttrDescTypeEx.getAttrName(this._curCvoInfo.zhuhunAttrList[i][0]) + "+" + value_1 + "%";
                }
                else
...
__reflect(ZhuhunView.prototype, "ZhuhunView");
