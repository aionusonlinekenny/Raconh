 ...
 * 2018.4.9
 */
var SysNoticeItemObject = (function (_super) {
    __extends(SysNoticeItemObject, _super);
    function SysNoticeItemObject() {
    ...
    SysNoticeItemObject.prototype.start = function () {
    ...
    SysNoticeItemObject.prototype.drawAll = function () {
    ...
    SysNoticeItemObject.prototype.draw = function () {
        _super.prototype.draw.call(this);
        if (this.isInvalid("drawItems"))
            this.drawItems();
    };
    SysNoticeItemObject.prototype.drawItems = function () {
        var col = 0;
        var row = 0;
        var itemX;
        var itemY;
        for (var i = 0; i < this._itemInfoList.length; i++) {
            ...
            itemX = col * (SysNoticeItemObject.ITEM_WIDTH + this._spacing);
            itemY = row * (SysNoticeItemObject.ITEM_WIDTH + this._spacing);
            /**背景图 */
            var bg = Manager.pool.create(BitmapRes, "common_itemBg_png"); //common_di2_png
            bg.x = itemX;
            bg.y = itemY;
     ...
     * spacing:间距
     */
    SysNoticeItemObject.prototype.reuse = function (itemInfoList, col, spacing) {
        if (col === void 0) { col = 10; }
        if (spacing === void 0) { spacing = 11; }
    ...
    SysNoticeItemObject.prototype.unuse = function () {
        this.cleanAll();
        _super.prototype.unuse.call(this);
    };
    SysNoticeItemObject.prototype.cleanData = function () {
        if (this._bgList) {
    ...
    SysNoticeItemObject.prototype.cleanAll = function () {
    ...
    SysNoticeItemObject.prototype.getItem = function (id) {
        return this._itemList[id];
    };
    SysNoticeItemObject.prototype.updateItemInfo = function (itemInfoList) {
        this._itemInfoList = itemInfoList;
        this.cleanData();
        // this.invalidate("drawItems");
        this.drawItems();
    };
    SysNoticeItemObject.prototype.getItemInfo = function () {
        return this._itemInfoList;
    };
    Object.defineProperty(SysNoticeItemObject.prototype, "selectIndex", {
        /**
         * 返回当前选中物品序号
         */
        get: function () {
    ...
    SysNoticeItemObject.prototype.dispose = function () {
    ...
    SysNoticeItemObject.ITEM_WIDTH = 160;
    return SysNoticeItemObject;
}(RenderSprite));
__reflect(SysNoticeItemObject.prototype, "SysNoticeItemObject");
//# sourceMappingURL=SysNoticeItemObject.js.map