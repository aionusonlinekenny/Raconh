...
var Panel2 = (function (_super) {
    ...
    Panel2.prototype.configUI = function () {
    ...
    Object.defineProperty(Panel2.prototype, "showBottomBack", {
        set: function (value) {
    ...
    Panel2.prototype.showBottomBackHandler = function () {
    ...
    Panel2.prototype.removeEvent = function () {
    ...
    Panel2.prototype.onResizeHandler = function (e) {
        this.uiContainer.x = Math.round((Manager.global.gameMain.stage.stageWidth - this.uiContainer.width) >> 1);
    };
    Panel2.prototype.onNameLevelUpdateHandler = function (e) {
    ...
    Panel2.prototype.onCoinUpdateHandler = function (e) {
        switch (this.resType) {
    ...
    Panel2.prototype.onGoldUpdateHandler = function (e) {
        this.txtGold.text = StringUtils.getBigNum(Manager.model.self.attrInfo.gold);
    };
    /** 设置人物金钱 */
    Panel2.prototype.setTopGameMoney = function (type) {
        this.resType = type;
        this.onCoinUpdateHandler();
    };
    Panel2.prototype.onClickHandler = function (e) {
    ...
    Panel2.prototype.show = function () {
    ...
    Panel2.prototype.hide = function () {
        this.dispose();
    };
    Panel2.prototype.dispose = function () {
        this.removeEvent();
        if (this.parent != null)
            this.parent.removeChild(this);
        ObjectUtil.removes(this.backImg, this.bottomBackImg, this.titleBg1, this.titleBg2, this.closeBtn, this._kuangBg, this.downFrameImg, this.backBtn, this._titleImg, this._backCoin, this._backGold, this.iconCoin, this._iconGold, this._payBtn, this.imageContainer, this.topContainer, this.uiContainer);
        if (this.backImg)
...
__reflect(Panel2.prototype, "Panel2", ["IViewManager"]);
